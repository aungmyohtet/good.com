  ...
  triggerNextStep(data) {
    ...
    if (isEnd) {
      ...
      this.setState({ renderedSteps, currentStep, previousStep }, () => {
        console.log('nextStep is ' + JSON.stringify(nextStep));
        if (nextStep.user) {
          this.setState({ disabled: false }, () => {
            this.input.focus();
          });
          ...
          self = this;
          nextStep.selections(function (data) {
            nextStep.selections = data;
            renderedSteps.push(nextStep);
            previousSteps.push(nextStep);
            self.setState({ renderedSteps, previousSteps });
          });
        }
        else if (nextStep.options && nextStep.options instanceof Function) {
          console.log('nextStep.options is a function');
          self = this;
          nextStep.options(function (data) {
            nextStep.options = data;
            renderedSteps.push(nextStep);
            previousSteps.push(nextStep);
            self.setState({ renderedSteps, previousSteps });
          });
          ...
          console.log('type of nextStep.options ' + typeof nextStep.options);
          console.log(JSON.stringify(nextStep.options));
          renderedSteps.push(nextStep);
          previousSteps.push(nextStep);
